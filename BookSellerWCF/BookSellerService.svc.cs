...
namespace BookSellerWCF
{
    ...
    public class BookSellerService : IBookSellerService
    {
        ...
        {
            bookList.Add(new Book("1234567891234", "The history of my life !", "Le Grand Martin", "Le meilleur", 1000));
            bookList.Add(new Book("4242424242424", "H2G2", "Douglas Adams", "Science-fiction - Comédie", 42.00));
            bookList.Add(new Book("9780375826689", "Eragon", "Christopher Paolini", "C'est dla merde", 0.01));
            bookList.Add(new Book("9782747014557", "L'Ainé", "Christopher Paolini", "C'est dla merde", 0.01));
        }
